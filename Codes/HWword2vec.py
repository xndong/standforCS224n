...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 13 17:54:50 2021
...
@author: DongXiaoning
"""
# implement skip-gram IN word2vec
# https://towardsdatascience.com/word2vec-from-scratch-with-numpy-8786ddd49e72
# A jupyter notebook in the above link: https://github.com/ujhuyz0110/wrd_emb
...
def get_tokens(filename):
    with open(filename, 'r') as file:
        tokens = []
        for lino,line in enumerate(tqdm(file.readlines())):
            token = tokenize(line)
            tokens = tokens + token
    return tokens


filename = 'smallwiki.txt'
...
paras = skipgram_model_training(X, Y_one_hot, vocab_size, 50, 0.005, 5000, batch_size=128, parameters=None, print_cost=True)
